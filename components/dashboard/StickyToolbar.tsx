...
export default function StickyToolbar({
  ...
  if (!result && !improvedResult) return null;
  ...
  return (
    <div className="sticky bottom-5 z-40 mx-auto w-full max-w-7xl px-4 md:px-6">
      <div className="rounded-2xl border border-zinc-700/80 bg-zinc-950/90 p-3 shadow-2xl shadow-black/30 backdrop-blur-xl">
